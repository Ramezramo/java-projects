...
public class buttons_inquiz_with_pro_6_10 extends JFrame implements ActionListener {
	...
	Timer timer = new Timer(500,new ActionListener() {
		...
		@Override
		public void actionPerformed(ActionEvent e) {/*this will listen to the clicked button and will make this action */
			seconds --;
...
//        };
	...
	public buttons_inquiz_with_pro_6_10 () { 
...
//		txt_area.setText("hi user");
		ImageIcon icon = new ImageIcon("D:\\programming\\java files\\learning\\j8\\procode_5_40\\src\\procode_5_40\\photo.png");
		
		
		btn_A.setBounds(0,140,200,50);
		btn_A.setFont(new Font("MV BOLI",Font.BOLD,25));
		btn_A.setBackground(new Color (53,55,60));
		btn_A.setFocusable(false);// will remove the box that arroun the text
		btn_A.addActionListener(this);// here the button will send the action to action listener
		btn_A.setText("A");
		btn_A.setIcon(icon);
		btn_A.setHorizontalTextPosition(JButton.CENTER);
		btn_A.setVerticalTextPosition(JButton.BOTTOM);
...
//		System.out.println(true_answer);
		...
		if ((boolean)clicked.equals((String)true_answer) ){
...
//				}
		...
		}else {/* IF THE ANSWER IS FALSE WILL MAKE IT RED  */
			if ((boolean)clicked.equals((String)"A")) {
				this.clickedbutton = "None";
				answer_labelA.setForeground(new Color(255,0,0));}
			else if ((boolean)clicked.equals((String)"B")) {
				this.clickedbutton = "None";
				answer_labelB.setForeground(new Color(255,0,0));}
			else if ((boolean)clicked.equals((String)"C")) {
				this.clickedbutton = "None";
				answer_labelC.setForeground(new Color(255,0,0));}
			else if ((boolean)clicked.equals((String)"D")) {
				this.clickedbutton = "None";
