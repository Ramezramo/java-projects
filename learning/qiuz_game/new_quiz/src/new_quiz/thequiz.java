...
public class thequiz implements ActionListener {
	String[] questions = {
...
//		if ((char)answers[index] == this.clickedbutton ) 
		System.out.println(String.valueOf(this.clickedbutton));
		
		System.out.println(String.valueOf(answers[index]));
		if (String.valueOf(this.clickedbutton) == String.valueOf(answers[index])) {
